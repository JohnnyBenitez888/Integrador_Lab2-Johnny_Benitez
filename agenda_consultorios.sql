...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-10-2024 a las 04:14:03
...
CREATE TABLE `turnos` (
  ...
  `horario_inicio` varchar(50) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `horario_final` varchar(50) COLLATE utf8mb3_spanish_ci DEFAULT NULL,
...
ALTER TABLE `agendas`
  ...
  ADD CONSTRAINT `agendas_ibfk_4` FOREIGN KEY (`id_dia`) REFERENCES `dias` (`id_dia`) ON DELETE RESTRICT ON UPDATE RESTRICT,
